...
typedef struct DisasContext {
    ...
    #ifdef RABBITS
    CPUState            *env;
    target_ulong        last_decoded_pc_addr;
    int                 b_first_instruction_in_tb;
    #endif
} DisasContext;
...
#include "rabbits/op_annotations.h"
...
static int disas_cp15_insn(CPUState *env, DisasContext *s, uint32_t insn)
{
	...
	case 0x0e070f16: /* 0, c7, c6, 0: Invalidate Entire Dcache */
		 /* TODO: check ARM version : !v7 */
		 gen_helper_invalidate_dcache_ALL(cpu_env);
		 break;
	case 0x0e070f36: /* 0, c7, c6, 1: Invalidate Dcache line by MVA */
		 /* TODO: check ARM version */
		 rd = (insn >> 12) & 0xf;
		 tmp = load_reg(s, rd);
		 gen_helper_invalidate_dcache_MVA(cpu_env, tmp);
		 tcg_temp_free_i32(tmp);
		 break;
	case 0x0e070f3a: /* 0, c7, c10, 1: Clean Dcache line by MVA*/
		 /* TODO: check ARM version */
		 rd = (insn >> 12) & 0xf;
		 tmp = load_reg(s, rd);
		 gen_helper_flush_dcache_MVA(cpu_env, tmp);
		 tcg_temp_free_i32(tmp);
		 break;
    case 0x0e070f1a: /* 0, c7, c10, 1: Clean Entire Dcache */
		 gen_helper_flush_dcache_ALL(cpu_env);
         break;
    case 0x0e070f3e: /* 0, c7, c14, 1: Clean and Invalidate Dcache line by MVA */
		 rd = (insn >> 12) & 0xf;
		 tmp = load_reg(s, rd);
		 gen_helper_flush_dcache_MVA(cpu_env, tmp);
		 gen_helper_invalidate_dcache_MVA(cpu_env, tmp);
		 tcg_temp_free_i32(tmp);
         break;
    case 0x0e070f1e: /* 0, c7, c14, 0: Clean and Invalidate Entire Dcache */
        /* TODO: check ARM version : !v7 */
		 gen_helper_flush_dcache_ALL(cpu_env);
		 gen_helper_invalidate_dcache_ALL(cpu_env);
        break;
...
//        #ifndef RABBITS_TRACE_EVENT
        gen_op_inc_crt_nr_cycles (env, ARM_COCPU_MRC);
//        #endif
        #endif
...
static inline void gen_jmp (DisasContext *s, uint32_t dest)
{
    if (unlikely(s->singlestep_enabled)) {
        ...
        #ifndef RABBITS_TRACE_EVENT
        gen_op_icache_access_n (s->last_decoded_pc_addr + 4, JUMP_EXTRA_LOADED_INSTRUCTIONS);
        gen_op_inc_crt_nr_cycles (s->env, ARM_JUMP);
        #else
...
static void gen_exception_return(DisasContext *s, TCGv pc)
{
    ...
    tcg_temp_free_i32(tmp);
    s->is_jmp = DISAS_UPDATE;
    #if defined(RABBITS) && defined (RABBITS_SOFT_DEBUG_ENABLED)
    gen_op_restore_single_step ();
    #endif
}
                               ...
                               TCGv addr, int size)
{
    ...
    #if defined (RABBITS) && defined (IMPLEMENT_FULL_CACHES)
    tcg_gen_mov_i32(cpu_exclusive_addr, addr);
    gen_op_fc_call_0p ((tcg_target_long) just_synchronize);
    tcg_gen_mov_i32(addr, cpu_exclusive_addr);
    gen_op_fc_call_0p ((tcg_target_long) helper_mark_exclusive);
    tcg_gen_mov_i32(addr, cpu_exclusive_addr);
    #endif
...
{
    #if defined (RABBITS) && defined (IMPLEMENT_FULL_CACHES)
    gen_op_fc_call_0p ((tcg_target_long) helper_clrex);
    #endif
                                ...
                                TCGv addr, int size)
{
    ...
    gen_op_fc_call_0p ((tcg_target_long) just_synchronize);
    tmp = tcg_temp_new_i32();
    tcg_gen_helperN(helper_test_exclusive, 0, 0, tmp, 0, NULL);
    tcg_gen_mov_i32(addr, cpu_exclusive_addr);
    ...
    #if defined (RABBITS) && defined (IMPLEMENT_FULL_CACHES)
    gen_op_fc_call_0p ((tcg_target_long) call_wait_wb_empty);
    gen_op_fc_call_0p ((tcg_target_long) helper_clrex);
    tcg_gen_mov_i32(addr, cpu_exclusive_addr);
    #endif
...
static void disas_arm_insn(CPUState * env, DisasContext *s)
{
    ...
    #ifdef RABBITS
    {
    #if defined(RABBITS_IMPLEMENT_CACHES) || defined(RABBITS_LOG_INFO)
    target_ulong    paddr = env->rabbits.last_accesed_phys_addr;
    s->last_decoded_pc_addr = env->rabbits.last_accesed_phys_addr;
...
//            #endif
            ...
            if (op1 == 1) {
                ...
                #ifdef RABBITS
//                #ifndef RABBITS_TRACE_EVENT
                gen_op_inc_crt_nr_cycles (env, ARM_MUL32);
//                #endif
                #endif
                ...
                #ifdef RABBITS
//                #ifndef RABBITS_TRACE_EVENT
                gen_op_inc_crt_nr_cycles (env, ARM_MUL16);
//                #endif
                #endif
...
//                #ifndef RABBITS_TRACE_EVENT
                if (shift)
                    gen_op_inc_crt_nr_cycles (env, ARM_REGISTER_SHIFT);
//                #endif
                #endif
...
//                        #endif
                        ...
                        if (insn & (1 << 22)) {
                            ...
                            #ifdef RABBITS
//                            #ifndef RABBITS_TRACE_EVENT
                            gen_op_inc_crt_nr_cycles (env, ARM_MLS);
//                            #endif
                            #endif
                            ARCH(6T2);
                            tmp2 = load_reg(s, rn);
                            ...
                            #ifdef RABBITS
//                            #ifndef RABBITS_TRACE_EVENT
                            gen_op_inc_crt_nr_cycles (env, ARM_MLA);
//                            #endif
                            #endif
                            tmp2 = load_reg(s, rn);
                            tcg_gen_add_i32(tmp, tmp, tmp2);
...
//                            #endif
                    ...
                    if (insn & (1 << 23)) {
                        ...
                        #ifdef RABBITS
//                        #ifndef RABBITS_TRACE_EVENT
                        gen_op_inc_crt_nr_cycles (env, ARM_SWP);
//                        #endif
                        #endif
        ...
        do_ldst:
            ...
            if (insn & (1 << 20)) {
                ...
                #ifdef RABBITS
//                #ifndef RABBITS_TRACE_EVENT
                gen_op_inc_crt_nr_cycles (env, ARM_LOAD);
//                #endif
                #endif
                if (insn & (1 << 22)) {
                    tmp = gen_ld8u(tmp2, i);
                ...
                #ifdef RABBITS
//                #ifndef RABBITS_TRACE_EVENT
                gen_op_inc_crt_nr_cycles (env, ARM_STORE);
//                #endif
                #endif
                tmp = load_reg(s, rd);
                if (insn & (1 << 22))
...
//                #endif
        ...
        case 0xe:
            ...
            #ifdef RABBITS
//            #ifndef RABBITS_TRACE_EVENT
            gen_op_inc_crt_nr_cycles (env, ARM_COCPU);
//            #endif
            #endif
                                                  ...
                                                  int search_pc)
{
    ...
    #ifdef RABBITS
    dc->env = env;
    dc->last_decoded_pc_addr = (target_ulong) -1;
    dc->b_first_instruction_in_tb = 1;
    gen_op_tb_start (tb);
    #endif
    ...
    do {
        ...
        #ifdef RABBITS
//        #ifndef RABBITS_TRACE_EVENT
        gen_op_inc_crt_nr_cycles (env, ARM_NORMAL_INSTRUCTION);
//        #endif
        #endif
