...
DEF_HELPER_1(invalidate_dcache_ALL, void, env)
DEF_HELPER_2(invalidate_dcache_MVA, void, env, i32)
DEF_HELPER_1(flush_dcache_ALL, void, env)
DEF_HELPER_2(flush_dcache_MVA, void, env, i32)
