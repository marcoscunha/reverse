 ...
 * @param bErr
 */
void timer_device::write (uint32_t ofs, uint8_t be, uint8_t *data, bool &bErr)
{
 ...
 * @param bErr
 */
void timer_device::read (uint32_t ofs, uint8_t be, uint8_t *data, bool &bErr)
{
    *((uint32_t *)data + 0) = 0;
    *((uint32_t *)data + 1) = 0;
 ...
 * @param bWrite
 */
void timer_device::rcv_rqst (uint32_t ofs, uint8_t be,
