...
void sl_timer_device::write (uint32_t ofs, uint8_t be, uint8_t *data, bool &bErr)
{
    uint32_t                value;
...
void sl_timer_device::read (uint32_t ofs, uint8_t be, uint8_t *data, bool &bErr)
{
...
void sl_timer_device::rcv_rqst (uint32_t ofs, uint8_t be,
