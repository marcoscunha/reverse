...
void ramdac_device::write (uint32_t ofs, uint8_t be, uint8_t *data, bool &bErr)
{
...
void ramdac_device::read (uint32_t ofs, uint8_t be, uint8_t *data, bool &bErr)
{
    bErr = false;
    return;
