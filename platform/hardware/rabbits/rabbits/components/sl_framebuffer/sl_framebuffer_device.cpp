...
int      sl_fb_device::pids_ramdac[128];
uint8_t *sl_fb_device::shm_addr[128][2];
int      sl_fb_device::shmids[128][2];
int      sl_fb_device::nb_fb = 0;

void sl_fb_device::close_ramdacs ()
{
    int         i, status;
...
void sl_fb_device::write (uint32_t ofs, uint8_t be, uint8_t *data, bool &bErr)
{
...
void sl_fb_device::read (uint32_t ofs, uint8_t be, uint8_t *data, bool &bErr)
{
    bErr = false;
...
void sl_fb_device::rcv_rqst (uint32_t ofs, uint8_t be,
