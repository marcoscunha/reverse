...
{
public:
    virtual int get_no_cpus  () = 0;
    virtual unsigned long get_cpu_fv_level (int cpu) = 0;
    virtual void set_cpu_fv_level (int cpu, unsigned long val) = 0;
    ...
    virtual unsigned long get_cpu_ncycles (int cpu) = 0;
    ...
    virtual bool get_trace_enable (void) = 0;
    virtual void set_trace_enable (bool enable) = 0;
#endif
