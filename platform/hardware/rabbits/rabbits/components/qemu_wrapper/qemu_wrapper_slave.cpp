...
void qemu_wrapper_slave_device::write (uint32_t ofs, uint8_t be,
...
void qemu_wrapper_slave_device::read (uint32_t ofs, uint8_t be,
    uint8_t *data, bool &bErr)
{
...
void qemu_wrapper_slave_device::rcv_rqst (uint32_t ofs, uint8_t be,
