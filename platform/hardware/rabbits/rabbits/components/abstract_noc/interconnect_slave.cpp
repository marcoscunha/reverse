...
/**
* Name: interconnect_slave
* Function: create slave request and response fifos
* Inputs: name: slave name
*         parent: islave parent
*         srcid: slave id
*/
...
/**
* Name: ~interconnect_slave
* Function: delete slave request and response fifos
*/
...
/**
* Name: dispatch_responses_thread
* Function: read a slave 'response' queue message. Send it to the linked
*           master
*/
void interconnect_slave::dispatch_responses_thread ()
{
    ...
    while (1)
    {
          /// get response information from slave fifo
        rsp = m_queue_responses->Read ();

        wait (1, SC_NS);

          /// check is slave connected to a master
        ...
        if (master == NULL)
        {
          ...
          /// if yes.. send response to master fifo
