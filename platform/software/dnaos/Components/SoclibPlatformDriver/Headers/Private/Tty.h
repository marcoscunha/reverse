...
#ifndef SOCLIB_PLATFORM_TTY_PRIVATE_H
#define SOCLIB_PLATFORM_TTY_PRIVATE_H
...
extern device_cmd_t soclib_tty_commands;

extern int32_t soclib_tty_isr (void * data);
...
extern status_t soclib_tty_read (void * handler, void * destination,
    int64_t offset, int32_t * p_count);
extern status_t soclib_tty_write (void * handler, void * source,
    int64_t offset, int32_t * p_count);

extern status_t soclib_tty_control (void * handler, int32_t function,
