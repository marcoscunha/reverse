...
export APES_CC_FLAGS="-gdwarf-3 -Wall -Wno-format -std=c99"
export APES_AS_FLAGS="-gdwarf-3 -Wall -Werror -Wno-format -std=c99"

#export APES_CC_FLAGS="-gdwarf-3 -Wall -Wno-format -std=c99 -DWRITEBACK"
#export APES_AS_FLAGS="-gdwarf-3 -Wall -Werror -Wno-format -std=c99 -DWRITEBACK"
